// Portions of this file are derived from gnark-crypto's FFT implementation:
// https://github.com/Consensys/gnark-crypto/blob/0a975d747c416958f20ad4e785bcf102449a81c9/ecc/bn254/fr/fft/domain.go
// https://github.com/Consensys/gnark-crypto/blob/0a975d747c416958f20ad4e785bcf102449a81c9/ecc/bn254/fr/fft/fft.go
//
// Copyright 2020-2026 Consensys Software Inc.
// Licensed under the Apache License, Version 2.0; see the repository's LICENSE-APACHE file.
// Ported to Rust, generalized over arkworks fields, and otherwise modified by TACEO.
...
mod tests {
    ...
    fn random_values(size: usize, rng: &mut StdRng) -> Vec<Fr> {
